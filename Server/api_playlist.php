...
class Playlist {
    function Playlist($id_playlist, $name_playlist, $background_image_playlist, $icon_image_playlist, $description) {
...
while ($row = mysqli_fetch_assoc($data_playlist)) {
    array_push($arr_playlist, new Playlist($row['id_playlist'], $row['name_playlist'], $row['background_image_playlist'], $row['icon_image_playlist'], $row['description']));
}
